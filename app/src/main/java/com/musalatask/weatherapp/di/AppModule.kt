...
import com.musalatask.weatherapp.domain.use_case.*
...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideGetCitiesByTextUseCase(cityWeatherRepository: CityWeatherRepository): GetCitiesByText =
        GetCitiesByText(cityWeatherRepository)
}